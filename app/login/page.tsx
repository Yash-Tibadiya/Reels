        ...
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-2xl shadow-2xl shadow-purple-900/20 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                className="flex items-center justify-center px-4 py-2 bg-white/5 border border-white/20 rounded-xl text-white/80 hover:bg-white/10 hover:text-white transition-all duration-300 hover:scale-105"
              >
